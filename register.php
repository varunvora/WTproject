...
<script type = "text/javascript">
	...
	if(user == "" || name == null){
			e.preventDefault();
			document.getElementById("usercheck").innerHTML =" <img src='unchecked.gif'/> Please enter your name";  
	}
	else if ((user!=null || user!= "") && ((pass1==null || pass2 == null ||pass1!=pass2))){
		e.preventDefault(); document.getElementById("usercheck").innerHTML = " <img src='checked.gif'/>";
	}
